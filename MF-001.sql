...
-- Tiempo de generación: 16-11-2025 a las 23:17:38
...
ALTER TABLE `perfil_concepto`
  ADD PRIMARY KEY (`id_perfil_Perfil`,`id_familia_Familia`,`id_concepto_Concepto`),
...
--
ALTER TABLE `perfil_concepto`
  ADD CONSTRAINT `pc_fk_concepto` FOREIGN KEY (`id_concepto_Concepto`) REFERENCES `concepto` (`id_concepto`) ON UPDATE CASCADE,
  ADD CONSTRAINT `pc_fk_familia` FOREIGN KEY (`id_familia_Familia`) REFERENCES `familia` (`id_familia`) ON UPDATE CASCADE,
  ADD CONSTRAINT `pc_fk_perfil` FOREIGN KEY (`id_perfil_Perfil`) REFERENCES `perfil` (`id_perfil`) ON UPDATE CASCADE;
